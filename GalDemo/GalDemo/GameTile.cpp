...
void CGameTile::Enter( CGame * )
{
	...
	menu->AddCtrl(new CShadowMenu(ID_TITLE_MENU_START, L"开始游戏", pos));
	pos.y += t.GetHeight() + 10;
	menu->AddCtrl(new CShadowMenu(ID_TITLE_MENU_CONTINUE, L"继续游戏", pos));
	pos.y += t.GetHeight() + 10;
	menu->AddCtrl(new CShadowMenu(ID_TITLE_MENU_EXIT, L"离开游戏", pos));
